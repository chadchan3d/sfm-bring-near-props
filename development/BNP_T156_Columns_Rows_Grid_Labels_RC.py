...
OUT_PATH = r"C:\Users\Public\Documents\BNP_T156_Columns_Rows_Grid_Labels_RC.log"
...
BNP_SCRIPT_VERSION = u"1.0.0-rc52-columns-rows-grid-labels"
BNP_MODAL_MS = 100
BNP_CONTEXT_MS = 250
...
class BringNearPropsController(
    ...
    def _show_help(
        ...
        _bnp_info(
            ...
            u"For <b>Grid</b>, <b>Columns</b> and <b>Rows</b> choose the two axes that form the grid plane.<br>"
